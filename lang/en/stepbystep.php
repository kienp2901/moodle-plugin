...
$string['auto_create_steps'] = 'Create quiz component';
$string['auto_create_steps_label'] = 'Generate quiz/test component for vocabulary';
$string['auto_create_steps_help'] = 'If checked, a quiz component will be automatically created to test the generated vocabulary. If unchecked, only vocabulary steps will be created without quiz component.';
